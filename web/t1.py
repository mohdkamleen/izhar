...
<body class="animate__animated animate__zoomIn">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link fa fa-angle-double-down" download="task 1" href="t1.py"> Download </a>
            </li>

        </ul>
    </nav> <br>

    <object data="source/t1.1.py" style="width: 100%; height: 700px;"></object>
    <object data="source/t1.2.py" style="width: 100%; height: 800px;"></object>
    <object data="source/t1.3.py" style="width: 100%; height: 700px;"></object>
