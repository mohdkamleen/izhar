...
<head>
	...
	<title>Mohd Kamleen | Contact</title>
	<!-- title image favicon  -->
					...
					<div class="body_content_header">
						...
						<div class="header_top">
							<h3 style="padding: 10px 5%;">
								You are always welcome to contact me for any issue that pertains to the class, or
								anything else that might concern you, especially if you feel it interferes with your ...
								You are more than welcome to contact me for any issue using this form. * indicates
								required field. Name:*. Email:* or .phone:*. . Subject:*. Message:*.
							</h3>

							<div class="header_img">
								<img class="nav_background_img" src="media/image/undraw_contact_us_15o2.svg"
									alt="header image">
							</div>
						</div>
	...
	<div class="container2">
		...
		<div class="form">
			<div class="contact-info">
				...
				<p class="text">
					You are more than welcome to contact me for any issue using this form. * indicates required field.
					Name:*. Email:* or .phone:*. . Subject:*. Message:*.
				</p>

				<div class="info">
					<div class="information">
						<img src="media/image/undraw_smart_home_28oy.svg" class="icon" alt="" />
						<p>Sakrawal west Tanda(224190), Ambedkar Nagar(up) India</p>
					</div>
					<div class="information">
						<img src="media/image/undraw_best_place_r685.svg" class="icon" alt="" />
						<p>kamleenmohd@gmail.com</p>
					</div>
					<div class="information">
						<img src="media/image/undraw_contact_us_15o2.svg" class="icon" alt="" />
						<p>+91 9838706427</p>
					</div>
				</div>
			...
			<div class="contact-form2">
				...
				<form action="action/contact.py" method="POST">
					...
					<div class="input-container">
						<input autocomplete="off" required list="menu" name="subject" class="input" />
