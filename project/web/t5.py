...
<body class="animate__animated animate__zoomIn">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active disabled"> <b> Task 5. </b> </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link fa fa-angle-double-down" download="task 1" href="t5.py"> Download </a>
            </li>

        </ul>
    </nav>

    <object data="source/t5.1.py" style=" height: 400px; width: 100%;"></object>
    <object data="source/t5.2.py" style=" height: 500px; width: 100%;"></object>
    <object data="source/t5.3.py" style=" height: 400px; width: 100%;"></object>
    <object data="source/t5.4.py" style=" height: 600px; width: 100%;"></object>
    <object data="source/t5.5.py" style=" height: 800px; width: 100%;"></object>
</body>
