...
<head>
	...
	<title>Mohd Kamleen | LogIn </title>
	<!-- title image favicon  -->
					...
					<div class="body_content_header">
						...
						<div class="header_top">
							...
							<div class="header_img">
								<img class="nav_background_img" src="media/image/undraw_secure_login_pdn4.svg"
									alt="header image">
							</div>
						</div>
	...
	<div class="container2">
		...
		<div class="form">
			<div class="contact-info">
				<h3 class="title">Let's get in LogIn</h3>
				<p class="text">
					You are more than welcome to Login for any issue using this form. * indicates required field.
					 Email:* and .password:*. 
				</p>
