...
for x in data: 
  ...
  <form action="comment_edit.py"> 
    <tr>
      ...
      <td class="text-center"><input type="text" name="date_comment" style="border: none; outline: none; background: transparent;width:250px" value="%s"></td> 
...
print("""
    ...
    <h3>hosting image, audio, vedio, all file to digicoders url from my website <br> <br>
    <button class="btn"><a href="en.php">host</a></button>
    </h3>

    <h3>structure of hosting folder...

        <object data="../source/mainfolder.txt" style=" height: 350px; width: 100%;"></object>
    
    </h3>

    <h3>structure of all website file folder...

        <object data="../source/allfolder.txt" style=" height: 2500px; width: 100%;"></object>
